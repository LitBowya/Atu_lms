...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2024 at 10:36 AM
...
CREATE TABLE `lms_admin` (
  ...
  `admin_profile` varchar(125) NOT NULL,
  `admin_createdon` varchar(75) NOT NULL
...
INSERT INTO `lms_admin` (`admin_id`, `admin_email`, `admin_password`, `admin_username`, `admin_contact_no`, `admin_profile`, `admin_createdon`) VALUES
(3, 'admin@gmail.com', '$2y$10$Ws1d5kbul3xgvby6gGoyUueoYet4jqhQkAsLa/OKynYNsLt8RTwba', 'Admin', '0250784957', '66a2639ee8e218.73594825.jpg', '2024-07-25 16:39:26');
...
CREATE TABLE `lms_book` (
  ...
  `book_code` varchar(150) NOT NULL,
...
(12, 'A1', 'Enable', '2024-07-25 15:52:37', '2024-07-25 22:31:47');
...
(1, 'Btech Library', 'Accra Technical University', '0547894561', 'atulibrary@gmail.com', 10, 1.00, 3, 'GHC', 'Africa/Accra');
...
CREATE TABLE `lms_user` (
  ...
  `user_status` varchar(225) NOT NULL DEFAULT 'Enable',
  `user_created_on` varchar(30) NOT NULL,
  `user_updated_on` varchar(30) NOT NULL,
  `student_faculty` varchar(225) NOT NULL,
  `student_department` varchar(225) NOT NULL,
  `student_program` varchar(225) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `lms_issue_book`
  MODIFY `issue_book_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
